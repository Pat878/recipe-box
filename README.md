...
This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). You can view the final project [here](http://www.patmellon.com/recipe-box/).
