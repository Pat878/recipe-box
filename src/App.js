      ...
      <div>
        ...
        <Modal show={this.props.showModal} onHide={this.props.close}>
          ...
          <Modal.Body>
            ...
            Ingredients: <input className="form-control" onChange={this.props.onUpdate} value={this.props.newingredient}
              type="text"/>
              Recipe Name: <input className="form-control" onChange={this.props.onUpdateName} value={this.props.newRecipe}
                type="text"/>
                ...
                <div className={this.props.ingredientAlert ? "active" : "inactive"}>
                  ...
                  <div className="alert alert-danger" role="alert">
                    <button type="button" className="close" data-dismiss="alert" aria-label="Close" onClick={this.props.closeIngredientAlert}>
      ...
      deleteTask(e) {
        ...
        addTask (e){
          ...
          if (this.state.task != "") {
            ...
            else { this.setState({alert:true})}//alert("New recipe must have a name!")}
          ...
          editTask(e) {
            ...
            this.setState({edit: e.target.value, newingredient: this.state.ingredients[taskIndex], showModal: true, newRecipe: this.state.items[taskIndex]})
                  ...
                  <div className="container">
                    ...
                    <div className="well">
                      ...
                      <div className={this.state.alert ? "active" : "inactive"}>
                        ...
                        <div className="alert alert-danger" role="alert">
                          <button type="button" className="close" data-dismiss="alert" aria-label="Close" onClick={this.closeButton}>
                            <span aria-hidden="true">&times;</span>
                          </button>
                          <h4 className="alert-heading">Whoa there!</h4>
